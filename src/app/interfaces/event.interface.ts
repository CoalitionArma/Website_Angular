...
export interface EventRole {
  ...
  slottedUserId?: string; // Discord ID of slotted user (primary identifier for authority)
  slottedUserArmaGuid?: string; // ARMA GUID of slotted user (for ARMA server integration)
